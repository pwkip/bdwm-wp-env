 ...
 * specified in .bdwm-wp-env.json, validates it, and converts it into the format used
 ...
 * @param {string} options.workDirectoryPath Path to the work directory located in ~/.bdwm-wp-env.
