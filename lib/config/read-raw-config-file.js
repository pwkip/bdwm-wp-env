...
/**
 * Used to maintain back compatibility with older versions of the .bdwm-wp-env.json
 * file. Returns an object in the shape of the currently expected .bdwm-wp-env.json
 * version.
 *
